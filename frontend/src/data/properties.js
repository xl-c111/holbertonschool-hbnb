export const properties = [
  ...
  },
  {
    ...
    images: ["/mountain-villa-with-snow.png", "/secluded-mountain-villa.png", "/snow3.png"],
    guests: 6,
    bedrooms: 3,
    bathrooms: 2,
    description:
      "Luxurious mountain villa with stunning views of the Aspen peaks. Perfect for winter getaways with easy access to world-class skiing and year-round outdoor activities.",
  ...
  },
  {
    ...
    reviews: 92,
    image: "/MBH1.png",
    images: ["/MBH1.png", "/MBH2.png", "/MBH3.png", "/MBH4.png"],
    guests: 5,
    bedrooms: 3,
    bathrooms: 2,
    description:
      "Beautiful beachfront property with direct ocean access. Wake up to the sound of waves and enjoy stunning sunsets from your private deck.",
  ...
  },
  {
    ...
    images: ["/modern-cabin-in-forest.png", "/cabin1.png", "/cabin2.png"],
    guests: 4,
    bedrooms: 2,
    bathrooms: 1,
    description:
      "Cozy cabin nestled in the forest, offering a peaceful retreat from city life. Perfect for nature lovers and hiking enthusiasts.",
  ...
  },
  {
    ...
    images: ["/modern-desert-house-architecture.png", "/desert-house.png"],
    guests: 4,
    bedrooms: 2,
    bathrooms: 2,
    description:
      "Modern desert retreat with stunning architecture and panoramic mountain views. Features a private pool and spa for ultimate relaxation.",
  ...
  },
  {
    ...
    images: ["/modern-lake-house-with-dock.png", "/lakehouse1.png"],
    guests: 6,
    bedrooms: 3,
    bathrooms: 2,
    description:
      "Lakefront property with private dock and breathtaking water views. Perfect for summer water activities and winter snow sports.",
